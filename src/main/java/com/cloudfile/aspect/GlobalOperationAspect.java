...
import com.cloudfile.utils.VerifyUtils;
...
public class GlobalOperationAspect {
    ...
    @Pointcut("@annotation(com.cloudfile.annotation.GlobalInterceptor)")
    ...
    private void checkObjValue(Parameter parameter, Object value) {
        try {
            ...
            for (Field field : fields)  {
                ...
                field.setAccessible(true);//设置完后可以访问属性 即使是私有也可以
