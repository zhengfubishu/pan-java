package com.cloudfile.entity.constants;
...
public class Constants {
    ...
    public static final String REDIS_KEY_DOWNLOAD = "cloudfile:download:";

    public static final String REDIS_KEY_SYS_SETTING = "cloudfile:syssetting:";

    public static final String REDIS_KEY_USER_SPACE_USE = "cloudfile:user:spaceuse:";

    public static final String REDIS_KEY_USER_FILE_TEMP_SIZE = "cloudfile:user:file:temp:";
