...
////        String statusFileId = "xxxxxxxxxxxxxxxxxx";
...
//                // 修改点1：添加回调处理问答结果
//                chatDocUtil.chat(chatUrl, chatFileId, question, appId, secret, (result) -> {
//                    System.out.println("问答结果：" + result);
//                });
//
